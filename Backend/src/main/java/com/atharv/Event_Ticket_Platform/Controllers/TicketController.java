...
public class TicketController {
    ...
    public ResponseEntity<TicketPurchasedDto> purchaseTicket(@AuthenticationPrincipal UserPrincipal userPrincipal , @PathVariable Integer ticketTypeId){
        UUID purchaserId=userPrincipal.getUserId();
    ...
    @GetMapping
    public ResponseEntity<Page<TicketPurchasedDto>> listPurchasedTicket(@AuthenticationPrincipal UserPrincipal userPrincipal , Pageable pageable){
    ...
    @GetMapping("{ticketId}")
    public ResponseEntity<TicketPurchasedDetails> TicketDetails(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable UUID ticketId){
        UUID userId = userPrincipal.getUserId();
    ...
    public ResponseEntity<QrCodeDetails> QrDetails(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable UUID ticketId){
        UUID userId = userPrincipal.getUserId();
    ...
    public ResponseEntity<byte[]> getQrCode(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable UUID ticketId) throws IOException, WriterException {
        UUID userId = userPrincipal.getUserId();
