...
export const ThemeToggle = () => {
    ...
    return (
        ...
        >
            ...
            {/* Toggle Knob */}
            <div
                className={`absolute top-0.5 w-6 h-6 rounded-full bg-white shadow-lg transition-all duration-300 flex items-center justify-center ${isDark ? 'left-7' : 'left-0.5'
                    }`}
            >
                {/* Sun Icon */}
                <svg
                    className={`w-4 h-4 text-yellow-500 transition-all duration-300 ${isDark ? 'opacity-0 scale-0' : 'opacity-100 scale-100'}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                >
                    <path
                ...
                {/* Moon Icon */}
                <svg
                    className={`w-4 h-4 text-gray-700 absolute transition-all duration-300 ${isDark ? 'opacity-100 scale-100' : 'opacity-0 scale-0'}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                >
