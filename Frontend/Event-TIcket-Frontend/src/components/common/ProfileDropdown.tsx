...
export const ProfileDropdown = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="w-8 h-8 bg-gradient-to-br from-cyan-500 to-teal-600 rounded-full flex items-center justify-center text-white font-semibold group-hover:from-cyan-600 group-hover:to-teal-700 transition-all">
              ...
              <div className="py-1">
                ...
                {isOrganiser(user) ? (
                  <button
                    ...
                    className="w-full px-4 py-3 text-left hover:bg-cyan-50 dark:hover:bg-cyan-900/30 transition-colors flex items-center space-x-3"
                  >
                    <svg className="w-5 h-5 text-cyan-600 dark:text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                    </svg>
                    <div>
                      <p className="text-sm font-semibold text-cyan-600 dark:text-cyan-400">Organiser Dashboard</p>
