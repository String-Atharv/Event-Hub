              ...
              <Card key={event.id} className="hover:shadow-lg transition-shadow flex flex-col h-full">
                <div className="flex-1">
                  <div className="mb-3 sm:mb-4">
                    <h3 className="text-lg sm:text-xl font-semibold mb-2 line-clamp-1 text-gray-900 dark:text-white">{event.name}</h3>
                  ...
                  <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 line-clamp-2">{event.description}</p>

                  <div className="space-y-2 text-sm text-gray-500 dark:text-gray-400 mb-3 sm:mb-4">
                    ...
                    {event.ticketTypes && event.ticketTypes.length > 0 && (
                      <div className="pt-2 border-t">
                        <div className="flex items-center justify-between">
                          <span className="font-medium text-gray-700 dark:text-gray-300">Ticket Types:</span>
                          <span className="text-blue-600 dark:text-blue-400">{event.ticketTypes.length}</span>
                        </div>
