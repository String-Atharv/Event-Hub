        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div className="space-y-4">
                ...
                {filteredEvents.length === 0 ? (
                    <Card className="p-12 text-center bg-white dark:bg-netflix-dark">
...
const EventCard = ({ event, formatDate, getStatusColor }: EventCardProps) => {
    ...
    return (
        <Link to={`/events/${event.eventId}/analytics`}>
            <Card className="p-6 hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-indigo-200 dark:hover:border-indigo-700 cursor-pointer group bg-white dark:bg-netflix-dark">
                <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg group-hover:bg-indigo-600 transition-colors">
                        <svg className="w-5 h-5 text-indigo-600 dark:text-indigo-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-3 gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div className="text-center">
                        <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Tickets</p>
                        <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{event.totalTicketsSold}</p>
                    </div>
                    <div className="text-center">
                        <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider">Attendance</p>
                        <p className="text-lg font-bold text-purple-600 dark:text-purple-400">{event.overallAttendanceRate.toFixed(0)}%</p>
                    </div>
                </div>
